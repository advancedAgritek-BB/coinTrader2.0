...
to point directly to another location.
...
* **trading.short_selling** – enable short selling. Set to `true` only when your exchange account supports short selling (legacy keys: `allow_short` and `allow_shorting`).
